#python3 02_train_vae_gan.py --new_model

from vae.arch_vaegan import VAEGAN
import argparse
import numpy as np
import config
import os
...
def main(args):
  ...
  if not new_model:
    try:
      vaegan.set_weights('./vae/weights.h5')
    except:
  ...
  for epoch in range(epochs):
    ...
    vaegan.save_weights('./vae/weights.h5')
    print("weight saved")
    vaegan.train(data)
...
if __name__ == "__main__":
  ...
  parser.add_argument('--N',default = 5, help='number of episodes to use to train')
